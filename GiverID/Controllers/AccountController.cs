...
namespace GiverID.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ViewBag.Message = @"We have sent you an email to verify these login detials. 
        ...
        private async Task<string> SendEmailConfirmationTokenAsync(string userID, string subject)
        {
            ...
            await UserManager.SendEmailAsync(userID, subject, "Please <a href=\"" + callbackUrl + "\">click here</a> to confirm your account details.");
